...
//   | ForAllTyped (ns, expr) -> ForAllTyped (List.map (fun (n ,t) -> (rdName n, t)) ns, rdNames expr) 
//   | otherwise -> otherwise
//
//
...
//       (List.choose
//           (function
//           | Program.Def (n, vars, ts, b) ->
//             Some <| Program.Def (rdName n, List.map (fun (s, t) -> rdName s, t) vars, ts, rdNames b)
//           | _ -> None)
//           definitions)
//         (rdNames formula)
//   

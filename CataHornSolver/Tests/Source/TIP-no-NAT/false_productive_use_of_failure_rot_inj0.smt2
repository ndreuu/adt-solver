...
(assert (forall ((x_126858 Int) (x_126859 list_406) (x_126860 Int) (x_126861 list_406))
	(=> (distinct x_126858 x_126860) (diseqlist_400 (cons_400 x_126858 x_126859) (cons_400 x_126860 x_126861)))))
(assert (forall ((x_126858 Int) (x_126859 list_406) (x_126860 Int) (x_126861 list_406))
...
(assert (forall ((x_126837 list_406) (n_119 Int) (m_98 Int) (ys_246 list_406) (xs_905 list_406))
	(=> (and (distinct n_119 m_98) (rotate_13 x_126837 n_119 xs_905) (rotate_13 x_126837 m_98 ys_246)) false)))
(check-sat)

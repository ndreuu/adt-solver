...
(assert (forall ((x_996 list_20) (x_986 Int) (x_987 list_20) (z_91 Int))
	(=> (and (>= z_91 0) (take_3 x_996 z_91 x_987)) (take_3 (cons_20 x_986 x_996) (S_32 z_91) (cons_20 x_986 x_987)))))
(assert (forall ((z_91 Int))
	(take_3 nil_20 z_91 nil_20)))
...
(assert (forall ((x_1006 Int) (x_994 Int) (z_93 Int))
	(=> (and (>= z_93 0) (>= x_994 0) (x_992 x_1006 z_93 x_994)) (x_992 x_1006 (S_32 z_93) (S_32 x_994)))))
(assert (forall ((z_93 Int))
	(=> (>= z_93 0) (x_992 (S_32 z_93) (S_32 z_93) Z_90))))

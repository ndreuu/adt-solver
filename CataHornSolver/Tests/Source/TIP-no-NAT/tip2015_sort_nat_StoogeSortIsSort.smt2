...
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (plus_90 z x y))))
(declare-fun minus_242 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_242 z x y))))
(declare-fun lt_244 (Bool_229 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (< x y) (lt_244 true_229 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (< x y)) (lt_244 false_229 x y))))
(declare-fun leq_33 (Bool_229 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_33 true_229 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_33 false_229 x y))))
...
(define-fun idiv_7 ((z Int) (x Int) (y Int)) Bool (= z (div x y)))
(declare-fun drop_39 (list_157 Int list_157) Bool)
(assert (forall ((x_42207 list_157) (z_1360 Int) (xs_440 list_157) (z_1359 Int))
	(=> (and (>= z_1359 0) (drop_39 x_42207 z_1359 xs_440)) (drop_39 x_42207 (succ_89 z_1359) (cons_157 z_1360 xs_440)))))
(assert (forall ((z_1359 Int))
	(drop_39 nil_179 z_1359 nil_179)))
(assert (forall ((z Int) (x_42210 list_157))
	(=> (<= z 0) (drop_39 x_42210 z x_42210))))
...
(assert (forall ((x_42243 Int) (x_42244 Int) (x_42245 Int) (x_42246 Int) (x_42160 Int) (y_1499 Int) (z_1363 Int))
	(=> (and (distinct x_42244 x_42246) (plus_90 x_42243 y_1499 z_1363) (plus_90 x_42244 x_42160 x_42243) (plus_90 x_42245 x_42160 y_1499) (plus_90 x_42246 x_42245 z_1363)) false)))
(assert (forall ((x_42247 Int) (x_42248 Int) (x_42161 Int) (y_1500 Int))
	(=> (and (distinct x_42247 x_42248) (plus_90 x_42247 x_42161 y_1500) (plus_90 x_42248 y_1500 x_42161)) false)))
(assert (forall ((x_42249 Int) (x_42162 Int))
	(=> (and (distinct x_42249 x_42162) (plus_90 x_42249 x_42162 zero_91)) false)))
(assert (forall ((x_42250 Int) (x_42163 Int))
	(=> (and (distinct x_42250 x_42163) (plus_90 x_42250 zero_91 x_42163)) false)))
(assert (forall ((x_42251 list_157) (x_42252 list_157) (xs_443 list_157))
	(=> (and (diseqlist_157 x_42251 x_42252) (stoogesort_31 x_42251 xs_443) (isort_19 x_42252 xs_443)) false)))
(check-sat)

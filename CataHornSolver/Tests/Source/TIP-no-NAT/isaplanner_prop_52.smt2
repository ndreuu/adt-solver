(set-logic HORN)
(define-fun Z_152 () Int 0)
(define-fun S_53 ((x Int)) Int (+ x 1))
...
(assert (forall ((x_1592 Int) (x_1593 list_28) (x_1594 Int) (x_1595 list_28))
	(=> (distinct x_1592 x_1594) (diseqlist_28 (cons_28 x_1592 x_1593) (cons_28 x_1594 x_1595)))))
(assert (forall ((x_1592 Int) (x_1593 list_28) (x_1594 Int) (x_1595 list_28))
...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (x_1542 false_28 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (x_1542 true_28 x y))))

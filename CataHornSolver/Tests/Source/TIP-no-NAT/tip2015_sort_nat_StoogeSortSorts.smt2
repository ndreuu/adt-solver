...
(assert (forall ((x_17665 list_89) (z_662 Int) (xs_198 list_89) (z_661 Int))
	(=> (and (distinct 0 (succ_25 z_661)) (take_18 x_17665 z_661 xs_198)) (take_18 (cons_89 z_662 x_17665) (succ_25 z_661) (cons_89 z_662 xs_198)))))
(assert (forall ((z_661 Int))
	(=> (distinct 0 (succ_25 z_661)) (take_18 nil_96 (succ_25 z_661) nil_96))))
(assert (forall ((y_629 list_89))
	(take_18 nil_96 zero_25 y_629)))
(declare-fun plus_25 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (plus_25 z x y))))
(declare-fun minus_122 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_122 z x y))))
(declare-fun lt_123 (Bool_120 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (< x y) (lt_123 true_120 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (< x y)) (lt_123 false_120 x y))))
(declare-fun leq_9 (Bool_120 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_9 true_120 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_9 false_120 x y))))
...
(define-fun idiv_2 ((z Int) (x Int) (y Int)) Bool (= z (div x y)))
(declare-fun drop_20 (list_89 Int list_89) Bool)
(assert (forall ((x_17702 list_89) (z_669 Int) (xs_200 list_89) (z_668 Int))
	(=> (and (distinct (succ_25 z_668) 0) (drop_20 x_17702 z_668 xs_200)) (drop_20 x_17702 (succ_25 z_668) (cons_89 z_669 xs_200)))))
(assert (forall ((z_668 Int))
	(=> (distinct 0 (succ_25 z_668)) (drop_20 nil_96 (succ_25 z_668) nil_96))))
...
(assert (forall ((x_17738 Int) (x_17739 Int) (x_17740 Int) (x_17741 Int) (x_17660 Int) (y_646 Int) (z_672 Int))
	(=> (and (distinct x_17739 x_17741) (plus_25 x_17738 y_646 z_672) (plus_25 x_17739 x_17660 x_17738) (plus_25 x_17740 x_17660 y_646) (plus_25 x_17741 x_17740 z_672)) false)))
(assert (forall ((x_17742 Int) (x_17743 Int) (x_17661 Int) (y_647 Int))
	(=> (and (distinct x_17742 x_17743) (plus_25 x_17742 x_17661 y_647) (plus_25 x_17743 y_647 x_17661)) false)))
(assert (forall ((x_17744 Int) (x_17662 Int))
	(=> (and (distinct x_17744 x_17662) (plus_25 x_17744 x_17662 zero_25)) false)))
(assert (forall ((x_17745 Int) (x_17663 Int))
	(=> (and (distinct x_17745 x_17663) (plus_25 x_17745 zero_25 x_17663)) false)))
(assert (forall ((x_17746 list_89) (xs_203 list_89))
	(=> (and (stoogesort_4 x_17746 xs_203) (ordered_4 false_120 x_17746)) false)))
(check-sat)

...
(assert (forall ((x_265 Int) (x_266 list_5) (x_267 Int) (x_268 list_5))
	(=> (distinct x_265 x_267) (diseqlist_5 (cons_5 x_265 x_266) (cons_5 x_267 x_268)))))
(assert (forall ((x_265 Int) (x_266 list_5) (x_267 Int) (x_268 list_5))
...
(assert (forall ((x_240 list_5) (x_241 Int) (x_242 Int) (x_232 Int) (y_20 list_5) (xs_9 list_5))
	(=> (and (distinct x_241 x_242) true (x_230 x_240 xs_9 (cons_5 x_232 y_20)) (last_0 x_241 x_240) (last_0 x_242 (cons_5 x_232 y_20))) false)))
(assert (forall ((x_243 list_5) (x_244 Int) (x_245 Int) (xs_9 list_5))
	(=> (and (distinct x_244 x_245) false (x_230 x_243 xs_9 nil_5) (last_0 x_244 x_243) (last_0 x_245 nil_5)) false)))
(check-sat)

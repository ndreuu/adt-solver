...
(assert (forall ((x_4191 Int) (x_4192 list_66) (x_4193 Int) (x_4194 list_66))
	(=> (distinct x_4191 x_4193) (diseqlist_66 (cons_66 x_4191 x_4192) (cons_66 x_4193 x_4194)))))
(assert (forall ((x_4191 Int) (x_4192 list_66) (x_4193 Int) (x_4194 list_66))
...
(assert (forall ((x_4209 Heap_0) (x_4210 Int) (x_4211 Heap_0) (x_4212 Heap_0) (x_4213 Int) (x_4214 Heap_0))
	(=> (distinct x_4210 x_4213) (diseqHeap_0 (Node_1 x_4209 x_4210 x_4211) (Node_1 x_4212 x_4213 x_4214)))))
(assert (forall ((x_4209 Heap_0) (x_4210 Int) (x_4211 Heap_0) (x_4212 Heap_0) (x_4213 Int) (x_4214 Heap_0))
...
(assert (forall ((x_4156 Int) (z_430 Int) (ys_30 list_66) (x_4119 Int))
	(=> (and (distinct x_4119 z_430) (count_10 x_4156 x_4119 ys_30)) (count_10 x_4156 x_4119 (cons_66 z_430 ys_30)))))
...
(assert (forall ((x_4159 Int) (x_4160 Int) (x_4161 Int) (x_4162 Int) (x_4120 Int) (y_344 Int) (z_431 Int))
	(=> (and (distinct x_4160 x_4162) (plus_0 x_4159 y_344 z_431) (plus_0 x_4160 x_4120 x_4159) (plus_0 x_4161 x_4120 y_344) (plus_0 x_4162 x_4161 z_431)) false)))
(assert (forall ((x_4163 Int) (x_4164 Int) (x_4121 Int) (y_345 Int))
	(=> (and (distinct x_4163 x_4164) (plus_0 x_4163 x_4121 y_345) (plus_0 x_4164 y_345 x_4121)) false)))
(assert (forall ((x_4165 Int) (x_4122 Int))
	(=> (and (distinct x_4165 x_4122) (plus_0 x_4165 x_4122 zero_1)) false)))
(assert (forall ((x_4166 Int) (x_4123 Int))
	(=> (and (distinct x_4166 x_4123) (plus_0 x_4166 zero_1 x_4123)) false)))
(assert (forall ((x_4167 list_66) (x_4168 Int) (x_4169 Int) (x_4124 Int) (xs_124 list_66))
	(=> (and (distinct x_4168 x_4169) (hsort_0 x_4167 xs_124) (count_10 x_4168 x_4124 x_4167) (count_10 x_4169 x_4124 xs_124)) false)))
(check-sat)

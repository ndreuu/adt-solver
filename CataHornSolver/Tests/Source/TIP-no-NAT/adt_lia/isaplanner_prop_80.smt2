...
(assert (forall ((x_1403 Int) (x_1404 list_26) (x_1405 Int) (x_1406 list_26))
	(=> (distinct x_1403 x_1405) (diseqlist_26 (cons_26 x_1403 x_1404) (cons_26 x_1405 x_1406)))))
(assert (forall ((x_1403 Int) (x_1404 list_26) (x_1405 Int) (x_1406 list_26))
...
(assert (forall ((x_1372 list_26) (x_1363 Int) (x_1364 list_26) (z_132 Int))
	(=> (and (>= z_132 0) (take_6 x_1372 z_132 x_1364)) (take_6 (cons_26 x_1363 x_1372) (S_45 z_132) (cons_26 x_1363 x_1364)))))
(assert (forall ((z_132 Int))
	(take_6 nil_26 z_132 nil_26)))
(assert (forall ((z Int) (y_105 list_26))
	(=> (<= z 0) (take_6 nil_26 z y_105))))
(declare-fun len_5 (Int list_26) Bool)
(assert (forall ((x_1376 Int) (y_106 Int) (xs_36 list_26))
	(=> (and (>= x_1376 0) (len_5 x_1376 xs_36)) (len_5 (S_45 x_1376) (cons_26 y_106 xs_36)))))
(assert (forall ((z Int)) (=> (<= z 0) (len_5 z nil_26))))
(declare-fun x_1366 (Int Int Int) Bool)
(assert (forall ((x_1378 Int) (x_1368 Int) (z_133 Int))
	(=> (and (>= z_133 0) (>= x_1368 0) (x_1366 x_1378 z_133 x_1368)) (x_1366 x_1378 (S_45 z_133) (S_45 x_1368)))))
(assert (forall ((z_133 Int))
	(=> (>= z_133 0) (x_1366 (S_45 z_133) (S_45 z_133) Z_131))))
(assert (forall ((y_107 Int))
	(=> (>= y_107 0) (x_1366 Z_131 Z_131 y_107))))

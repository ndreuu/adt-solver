...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_16 true_153 x y))))
...
(define-fun idiv_3 ((z Int) (x Int) (y Int)) Bool (= z (div x y)))
...
(assert (forall ((x_22416 Int) (x_22417 Int) (x_22418 Int) (x_22419 Int) (x_22331 Int) (y_870 Int) (z_865 Int))
	(=> (and (distinct x_22417 x_22419) (times_9 x_22416 y_870 z_865) (times_9 x_22417 x_22331 x_22416) (times_9 x_22418 x_22331 y_870) (times_9 x_22419 x_22418 z_865)) false)))
(assert (forall ((x_22420 Int) (x_22421 Int) (x_22422 Int) (x_22423 Int) (x_22332 Int) (y_871 Int) (z_866 Int))
	(=> (and (distinct x_22421 x_22423) (plus_43 x_22420 y_871 z_866) (plus_43 x_22421 x_22332 x_22420) (plus_43 x_22422 x_22332 y_871) (plus_43 x_22423 x_22422 z_866)) false)))
(assert (forall ((x_22424 Int) (x_22425 Int) (x_22333 Int) (y_872 Int))
	(=> (and (distinct x_22424 x_22425) (times_9 x_22424 x_22333 y_872) (times_9 x_22425 y_872 x_22333)) false)))
(assert (forall ((x_22426 Int) (x_22427 Int) (x_22334 Int) (y_873 Int))
	(=> (and (distinct x_22426 x_22427) (plus_43 x_22426 x_22334 y_873) (plus_43 x_22427 y_873 x_22334)) false)))
(assert (forall ((x_22428 Int) (x_22429 Int) (x_22430 Int) (x_22431 Int) (x_22432 Int) (x_22335 Int) (y_874 Int) (z_867 Int))
	(=> (and (distinct x_22429 x_22432) (plus_43 x_22428 y_874 z_867) (times_9 x_22429 x_22335 x_22428) (times_9 x_22430 x_22335 y_874) (times_9 x_22431 x_22335 z_867) (plus_43 x_22432 x_22430 x_22431)) false)))
(assert (forall ((x_22433 Int) (x_22434 Int) (x_22435 Int) (x_22436 Int) (x_22437 Int) (x_22336 Int) (y_875 Int) (z_868 Int))
	(=> (and (distinct x_22434 x_22437) (plus_43 x_22433 x_22336 y_875) (times_9 x_22434 x_22433 z_868) (times_9 x_22435 x_22336 z_868) (times_9 x_22436 y_875 z_868) (plus_43 x_22437 x_22435 x_22436)) false)))
(assert (forall ((x_22438 Int) (x_22337 Int))
	(=> (and (distinct x_22438 x_22337) (times_9 x_22438 x_22337 (succ_45 zero_46))) false)))
(assert (forall ((x_22439 Int) (x_22338 Int))
	(=> (and (distinct x_22439 x_22338) (times_9 x_22439 (succ_45 zero_46) x_22338)) false)))
(assert (forall ((x_22440 Int) (x_22339 Int))
	(=> (and (distinct x_22440 x_22339) (plus_43 x_22440 x_22339 zero_46)) false)))
(assert (forall ((x_22441 Int) (x_22340 Int))
	(=> (and (distinct x_22441 x_22340) (plus_43 x_22441 zero_46 x_22340)) false)))
(assert (forall ((x_22442 Int) (x_22341 Int))
	(=> (and (distinct x_22442 zero_46) (times_9 x_22442 x_22341 zero_46)) false)))
(assert (forall ((x_22443 Int) (x_22342 Int))
	(=> (and (distinct x_22443 zero_46) (times_9 x_22443 zero_46 x_22342)) false)))
(assert (forall ((x_22444 list_109) (xs_269 list_109))
	(=> (and (stoogesort_10 x_22444 xs_269) (ordered_7 false_153 x_22444)) false)))
(check-sat)

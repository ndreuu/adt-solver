...
(assert (forall ((x_56242 Int) (x_56243 list_259) (x_56244 Int) (x_56245 list_259))
	(=> (distinct x_56242 x_56244) (diseqlist_259 (cons_259 x_56242 x_56243) (cons_259 x_56244 x_56245)))))
(assert (forall ((x_56242 Int) (x_56243 list_259) (x_56244 Int) (x_56245 list_259))
...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (x_56181 false_359 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (x_56181 true_359 x y))))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (x_56185 true_359 x y))))
(assert (forall ((x Int) (y Int)) (=> (> x y) (x_56185 false_359 x y))))

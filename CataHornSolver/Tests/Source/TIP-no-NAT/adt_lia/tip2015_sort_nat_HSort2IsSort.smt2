...
(assert (forall ((x_4610 Int) (x_4611 list_69) (x_4612 Int) (x_4613 list_69))
	(=> (distinct x_4610 x_4612) (diseqlist_69 (cons_69 x_4610 x_4611) (cons_69 x_4612 x_4613)))))
(assert (forall ((x_4610 Int) (x_4611 list_69) (x_4612 Int) (x_4613 list_69))
...
(assert (forall ((x_4628 Heap_1) (x_4629 Int) (x_4630 Heap_1) (x_4631 Heap_1) (x_4632 Int) (x_4633 Heap_1))
	(=> (distinct x_4629 x_4632) (diseqHeap_1 (Node_2 x_4628 x_4629 x_4630) (Node_2 x_4631 x_4632 x_4633)))))
(assert (forall ((x_4628 Heap_1) (x_4629 Int) (x_4630 Heap_1) (x_4631 Heap_1) (x_4632 Int) (x_4633 Heap_1))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_2 true_87 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_2 false_87 x y))))
...
(assert (forall ((x_4587 list_69) (x_4588 list_69) (xs_135 list_69))
	(=> (and (diseqlist_69 x_4587 x_4588) (hsort_1 x_4587 xs_135) (isort_0 x_4588 xs_135)) false)))
(check-sat)

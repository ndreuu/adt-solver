...
(assert (forall ((x_3148 list_53) (x_3135 Int) (x_3136 list_53) (z_322 Int))
	(=> (and (>= z_322 0) (take_11 x_3148 z_322 x_3136)) (take_11 (cons_53 x_3135 x_3148) (S_114 z_322) (cons_53 x_3135 x_3136)))))
(assert (forall ((z_322 Int))
	(take_11 nil_53 z_322 nil_53)))
(assert (forall ((z Int) (y_253 list_53))
	(=> (<= z 0) (take_11 nil_53 z y_253))))
(declare-fun len_10 (Int list_53) Bool)
(assert (forall ((x_3152 Int) (y_254 Int) (xs_96 list_53))
	(=> (and (>= x_3152 0) (len_10 x_3152 xs_96)) (len_10 (S_114 x_3152) (cons_53 y_254 xs_96)))))
(assert (forall ((z Int)) (=> (<= z 0) (len_10 z nil_53))))
(declare-fun drop_12 (list_53 Int list_53) Bool)
(assert (forall ((x_3154 list_53) (x_3139 Int) (x_3140 list_53) (z_323 Int))
	(=> (and (>= z_323 0) (drop_12 x_3154 z_323 x_3140)) (drop_12 x_3154 (S_114 z_323) (cons_53 x_3139 x_3140)))))
(assert (forall ((z_323 Int))
	(drop_12 nil_53 z_323 nil_53)))
(assert (forall ((z Int) (x_3157 list_53))
	(=> (<= z 0) (drop_12 x_3157 z x_3157))))

...
(assert (forall ((x_26222 Int) (x_26223 list_121) (x_26224 Int) (x_26225 list_121))
	(=> (distinct x_26222 x_26224) (diseqlist_121 (cons_121 x_26222 x_26223) (cons_121 x_26224 x_26225)))))
(assert (forall ((x_26222 Int) (x_26223 list_121) (x_26224 Int) (x_26225 list_121))
...
(assert (forall ((x_26094 list_121) (z_976 Int) (xs_319 list_121) (z_975 Int))
	(=> (and (>= z_975 0) (take_26 x_26094 z_975 xs_319)) (take_26 (cons_121 z_976 x_26094) (succ_55 z_975) (cons_121 z_976 xs_319)))))
(assert (forall ((z_975 Int))
	(take_26 nil_134 z_975 nil_134)))
(assert (forall ((z Int) (y_1008 list_121))
	(=> (<= z 0) (take_26 nil_134 z y_1008))))
(declare-fun plus_55 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (plus_55 z x y))))
(declare-fun times_12 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (* x y)) (times_12 z x y))))
(declare-fun minus_175 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_175 z x y))))
(declare-fun lt_179 (Bool_171 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (< x y) (lt_179 true_171 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (< x y)) (lt_179 false_171 x y))))
(declare-fun leq_19 (Bool_171 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_19 true_171 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_19 false_171 x y))))
...
(assert (forall ((x_26120 Int) (x_26121 Int) (y_1016 Int) (l_16 list_121))
	(=> (and (>= x_26121 0) (length_14 x_26121 l_16) (plus_55 x_26120 (succ_55 zero_56) x_26121)) (length_14 x_26120 (cons_121 y_1016 l_16)))))
...
(define-fun idiv_4 ((z Int) (x Int) (y Int)) Bool (= z (div x y)))
(declare-fun drop_28 (list_121 Int list_121) Bool)
(assert (forall ((x_26140 list_121) (z_984 Int) (xs_322 list_121) (z_983 Int))
	(=> (and (>= z_983 0) (drop_28 x_26140 z_983 xs_322)) (drop_28 x_26140 (succ_55 z_983) (cons_121 z_984 xs_322)))))
(assert (forall ((z_983 Int))
	(drop_28 nil_134 z_983 nil_134)))
(assert (forall ((z Int) (x_26143 list_121))
	(=> (<= z 0) (drop_28 x_26143 z x_26143))))
...
(assert (forall ((x_26171 Int) (x_26172 Int) (x_26173 Int) (x_26174 Int) (x_26081 Int) (y_1025 Int) (z_987 Int))
	(=> (and (distinct x_26172 x_26174) (times_12 x_26171 y_1025 z_987) (times_12 x_26172 x_26081 x_26171) (times_12 x_26173 x_26081 y_1025) (times_12 x_26174 x_26173 z_987)) false)))
(assert (forall ((x_26175 Int) (x_26176 Int) (x_26177 Int) (x_26178 Int) (x_26082 Int) (y_1026 Int) (z_988 Int))
	(=> (and (distinct x_26176 x_26178) (plus_55 x_26175 y_1026 z_988) (plus_55 x_26176 x_26082 x_26175) (plus_55 x_26177 x_26082 y_1026) (plus_55 x_26178 x_26177 z_988)) false)))
(assert (forall ((x_26179 Int) (x_26180 Int) (x_26083 Int) (y_1027 Int))
	(=> (and (distinct x_26179 x_26180) (times_12 x_26179 x_26083 y_1027) (times_12 x_26180 y_1027 x_26083)) false)))
(assert (forall ((x_26181 Int) (x_26182 Int) (x_26084 Int) (y_1028 Int))
	(=> (and (distinct x_26181 x_26182) (plus_55 x_26181 x_26084 y_1028) (plus_55 x_26182 y_1028 x_26084)) false)))
(assert (forall ((x_26183 Int) (x_26184 Int) (x_26185 Int) (x_26186 Int) (x_26187 Int) (x_26085 Int) (y_1029 Int) (z_989 Int))
	(=> (and (distinct x_26184 x_26187) (plus_55 x_26183 y_1029 z_989) (times_12 x_26184 x_26085 x_26183) (times_12 x_26185 x_26085 y_1029) (times_12 x_26186 x_26085 z_989) (plus_55 x_26187 x_26185 x_26186)) false)))
(assert (forall ((x_26188 Int) (x_26189 Int) (x_26190 Int) (x_26191 Int) (x_26192 Int) (x_26086 Int) (y_1030 Int) (z_990 Int))
	(=> (and (distinct x_26189 x_26192) (plus_55 x_26188 x_26086 y_1030) (times_12 x_26189 x_26188 z_990) (times_12 x_26190 x_26086 z_990) (times_12 x_26191 y_1030 z_990) (plus_55 x_26192 x_26190 x_26191)) false)))
(assert (forall ((x_26193 Int) (x_26087 Int))
	(=> (and (distinct x_26193 x_26087) (times_12 x_26193 x_26087 (succ_55 zero_56))) false)))
(assert (forall ((x_26194 Int) (x_26088 Int))
	(=> (and (distinct x_26194 x_26088) (times_12 x_26194 (succ_55 zero_56) x_26088)) false)))
(assert (forall ((x_26195 Int) (x_26089 Int))
	(=> (and (distinct x_26195 x_26089) (plus_55 x_26195 x_26089 zero_56)) false)))
(assert (forall ((x_26196 Int) (x_26090 Int))
	(=> (and (distinct x_26196 x_26090) (plus_55 x_26196 zero_56 x_26090)) false)))
(assert (forall ((x_26197 Int) (x_26091 Int))
	(=> (and (> x_26197 zero_56) (times_12 x_26197 x_26091 zero_56)) false)))
(assert (forall ((x_26198 Int) (x_26092 Int))
	(=> (and (> x_26198 zero_56) (times_12 x_26198 zero_56 x_26092)) false)))
(assert (forall ((x_26199 list_121) (x_26200 list_121) (xs_324 list_121))
	(=> (and (diseqlist_121 x_26199 x_26200) (stoogesort_19 x_26199 xs_324) (isort_13 x_26200 xs_324)) false)))
(check-sat)

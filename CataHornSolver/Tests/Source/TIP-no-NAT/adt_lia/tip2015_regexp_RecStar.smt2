...
(assert (forall ((x_25176 Bool_161) (x_25177 Bool_161) (x_23113 A_27) (y_934 list_116) (p_141 R_191))
	(=> (and (diseqBool_67 x_25176 x_25177) (recognise_6 x_25176 (Star_6 p_141) (cons_116 x_23113 y_934)) (recognise_6 x_25177 (Seq_12 p_141 (Star_6 p_141)) (cons_116 x_23113 y_934))) false)))
(assert (forall ((p_141 R_191))
	(=> (and (recognise_6 false_161 (Star_6 p_141) nil_129)) false)))
(check-sat)

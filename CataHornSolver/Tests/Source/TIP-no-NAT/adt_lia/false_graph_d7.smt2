...
(assert (forall ((x_107731 Int) (x_107732 Int) (x_107733 Int) (x_107734 Int))
	(=> (distinct x_107731 x_107733) (diseqpair_81 (pair_163 x_107731 x_107732) (pair_163 x_107733 x_107734)))))
(assert (forall ((x_107731 Int) (x_107732 Int) (x_107733 Int) (x_107734 Int))
	(=> (distinct x_107732 x_107734) (diseqpair_81 (pair_163 x_107731 x_107732) (pair_163 x_107733 x_107734)))))
...
(assert (forall ((x_107759 Int) (x_107760 list_356) (x_107761 Int) (x_107762 list_356))
	(=> (distinct x_107759 x_107761) (diseqlist_351 (cons_351 x_107759 x_107760) (cons_351 x_107761 x_107762)))))
(assert (forall ((x_107759 Int) (x_107760 list_356) (x_107761 Int) (x_107762 list_356))
...
(assert (forall ((x_107783 Int) (x_107784 Int))
	(=> (distinct x_107783 x_107784) (diseqMaybe_18 (Just_18 x_107783) (Just_18 x_107784)))))
...
(assert (forall ((x_107668 Int) (x_107575 Maybe_18) (z_2554 Int) (xs_840 list_356) (y_2937 Int))
	(=> (and (distinct y_2937 Z_2564) (index_4 x_107575 xs_840 x_107668) (minus_440 x_107668 y_2937 (S_595 Z_2564))) (index_4 x_107575 (cons_351 z_2554 xs_840) y_2937))))
...
(assert (forall ((x_107608 list_355) (c_62 Int) (c_61 Int) (u_20 Int) (v_20 Int) (z_2562 list_357) (a_106 list_356))
	(=> (and (distinct c_61 c_62) (colouring_8 x_107608 a_106 z_2562) (index_4 (Just_18 c_62) a_106 v_20) (index_4 (Just_18 c_61) a_106 u_20)) (colouring_8 (cons_350 true_419 x_107608) a_106 (cons_352 (pair_163 u_20 v_20) z_2562)))))

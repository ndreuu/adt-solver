...
(assert (forall ((x_33832 Int) (x_33833 list_143) (x_33834 Int) (x_33835 list_143))
	(=> (distinct x_33832 x_33834) (diseqlist_143 (cons_143 x_33832 x_33833) (cons_143 x_33834 x_33835)))))
(assert (forall ((x_33832 Int) (x_33833 list_143) (x_33834 Int) (x_33835 list_143))
...
(assert (forall ((x_33850 Heap_6) (x_33851 Int) (x_33852 Heap_6) (x_33853 Heap_6) (x_33854 Int) (x_33855 Heap_6))
	(=> (distinct x_33851 x_33854) (diseqHeap_6 (Node_9 x_33850 x_33851 x_33852) (Node_9 x_33853 x_33854 x_33855)))))
(assert (forall ((x_33850 Heap_6) (x_33851 Int) (x_33852 Heap_6) (x_33853 Heap_6) (x_33854 Int) (x_33855 Heap_6))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_30 true_207 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_30 false_207 x y))))
...
(assert (forall ((x_33808 list_143) (xs_386 list_143))
	(=> (and (hsort_6 x_33808 xs_386) (ordered_10 false_207 x_33808)) false)))
(check-sat)

...
(assert (forall ((x_49395 Int) (x_49396 list_186) (x_49397 Int) (x_49398 list_186))
	(=> (distinct x_49395 x_49397) (diseqlist_186 (cons_186 x_49395 x_49396) (cons_186 x_49397 x_49398)))))
(assert (forall ((x_49395 Int) (x_49396 list_186) (x_49397 Int) (x_49398 list_186))
...
(assert (=> (distinct (succ_105 zero_108) (succ_105 (succ_105 zero_108))) (third_9 zero_108 (succ_105 zero_108))))
(assert (third_9 zero_108 (succ_105 (succ_105 zero_108))))
(assert (forall ((x_49296 Int) (x_49297 Int) (x_49298 Int) (y_1720 Int))
	(=> (and (distinct (succ_105 y_1720) (succ_105 (succ_105 zero_108))) (distinct (succ_105 y_1720) (succ_105 zero_108)) (minus_276 x_49297 (succ_105 y_1720) (succ_105 (succ_105 (succ_105 zero_108)))) (third_9 x_49298 x_49297) (plus_108 x_49296 (succ_105 zero_108) x_49298)) (third_9 x_49296 (succ_105 y_1720)))))
(assert (third_9 zero_108 (succ_105 (succ_105 zero_108))))
(assert (=> (distinct (succ_105 zero_108) (succ_105 (succ_105 zero_108))) (third_9 zero_108 (succ_105 zero_108))))
(assert (third_9 zero_108 (succ_105 (succ_105 zero_108))))
(assert (=> (and (distinct zero_108 (succ_105 (succ_105 zero_108))) (distinct zero_108 (succ_105 zero_108))) (third_9 zero_108 zero_108)))
(declare-fun twoThirds_4 (Int Int) Bool)
(assert (twoThirds_4 (succ_105 zero_108) (succ_105 (succ_105 zero_108))))
(assert (=> (distinct (succ_105 zero_108) (succ_105 (succ_105 zero_108))) (twoThirds_4 (succ_105 zero_108) (succ_105 zero_108))))
(assert (twoThirds_4 (succ_105 zero_108) (succ_105 (succ_105 zero_108))))
(assert (forall ((x_49307 Int) (x_49308 Int) (x_49309 Int) (y_1721 Int))
	(=> (and (distinct (succ_105 y_1721) (succ_105 (succ_105 zero_108))) (distinct (succ_105 y_1721) (succ_105 zero_108)) (minus_276 x_49308 (succ_105 y_1721) (succ_105 (succ_105 (succ_105 zero_108)))) (twoThirds_4 x_49309 x_49308) (plus_108 x_49307 (succ_105 (succ_105 zero_108)) x_49309)) (twoThirds_4 x_49307 (succ_105 y_1721)))))
(assert (twoThirds_4 (succ_105 zero_108) (succ_105 (succ_105 zero_108))))
(assert (=> (distinct (succ_105 zero_108) (succ_105 (succ_105 zero_108))) (twoThirds_4 (succ_105 zero_108) (succ_105 zero_108))))
(assert (twoThirds_4 (succ_105 zero_108) (succ_105 (succ_105 zero_108))))
(assert (=> (and (distinct zero_108 (succ_105 (succ_105 zero_108))) (distinct zero_108 (succ_105 zero_108))) (twoThirds_4 zero_108 zero_108)))
...
(assert (forall ((x_49337 Int) (z_1546 Int) (ys_161 list_186) (x_49268 Int))
	(=> (and (distinct x_49268 z_1546) (count_27 x_49337 x_49268 ys_161)) (count_27 x_49337 x_49268 (cons_186 z_1546 ys_161)))))
...
(assert (forall ((x_49363 Int) (x_49364 Int) (x_49365 Int) (x_49366 Int) (x_49277 Int) (y_1731 Int) (z_1549 Int))
	(=> (and (distinct x_49364 x_49366) (plus_108 x_49363 y_1731 z_1549) (plus_108 x_49364 x_49277 x_49363) (plus_108 x_49365 x_49277 y_1731) (plus_108 x_49366 x_49365 z_1549)) false)))
(assert (forall ((x_49367 Int) (x_49368 Int) (x_49278 Int) (y_1732 Int))
	(=> (and (distinct x_49367 x_49368) (plus_108 x_49367 x_49278 y_1732) (plus_108 x_49368 y_1732 x_49278)) false)))
(assert (forall ((x_49369 Int) (x_49279 Int))
	(=> (and (distinct x_49369 x_49279) (plus_108 x_49369 x_49279 zero_108)) false)))
(assert (forall ((x_49370 Int) (x_49280 Int))
	(=> (and (distinct x_49370 x_49280) (plus_108 x_49370 zero_108 x_49280)) false)))
(assert (forall ((x_49371 list_186) (x_49372 Int) (x_49373 Int) (x_49281 Int) (xs_514 list_186))
	(=> (and (distinct x_49372 x_49373) (nstoogesort_28 x_49371 xs_514) (count_27 x_49372 x_49281 x_49371) (count_27 x_49373 x_49281 xs_514)) false)))
(check-sat)

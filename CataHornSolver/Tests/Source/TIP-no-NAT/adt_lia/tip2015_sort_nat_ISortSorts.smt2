...
(assert (forall ((x_12466 Int) (x_12467 list_82) (x_12468 Int) (x_12469 list_82))
	(=> (distinct x_12466 x_12468) (diseqlist_82 (cons_82 x_12466 x_12467) (cons_82 x_12468 x_12469)))))
(assert (forall ((x_12466 Int) (x_12467 list_82) (x_12468 Int) (x_12469 list_82))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_7 true_108 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_7 false_108 x y))))

...
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (add_128 z x y))))
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_126 z x y))))
...
(assert (forall ((x_18012 Int) (y_674 Int))
	(=> (< x_18012 y_674) (div_123 Z_695 x_18012 y_674))))
(assert (forall ((x_18012 Int) (y_674 Int) (r_144 Int) (z_696 Int))
	(=> (and (>= x_18012 y_674) (minus_126 z_696 x_18012 y_674) (div_123 r_144 z_696 y_674)) (div_123 (S_205 r_144) x_18012 y_674))))
(assert (forall ((x_18012 Int) (y_674 Int))
	(=> (< x_18012 y_674) (mod_123 x_18012 x_18012 y_674))))
(assert (forall ((x_18012 Int) (y_674 Int) (r_144 Int) (z_696 Int))
	(=> (and (>= x_18012 y_674) (minus_126 z_696 x_18012 y_674) (mod_123 r_144 z_696 y_674)) (mod_123 r_144 x_18012 y_674))))
...
(assert (forall ((x_18035 Int) (x_18036 list_90) (x_18037 Int) (x_18038 list_90))
	(=> (distinct x_18035 x_18037) (diseqlist_90 (cons_90 x_18035 x_18036) (cons_90 x_18037 x_18038)))))
(assert (forall ((x_18035 Int) (x_18036 list_90) (x_18037 Int) (x_18038 list_90))
...
(assert (forall ((x_17962 Int) (y_667 list_90))
	(=> (<= x_17962 Z_695) (take_19 nil_97 x_17962 y_667))))
(assert (forall ((x_18013 Int) (x_17976 list_90) (z_690 Int) (xs_204 list_90) (x_17962 Int))
	(=> (and (> x_17962 Z_695) (take_19 x_17976 x_18013 xs_204) (minus_126 x_18013 x_17962 (S_205 Z_695))) (take_19 (cons_90 z_690 x_17976) x_17962 (cons_90 z_690 xs_204)))))
(assert (forall ((x_17962 Int) (y_667 list_90))
	(=> (<= x_17962 Z_695) (take_19 nil_97 x_17962 y_667))))
(assert (forall ((x_17962 Int))
	(=> (> x_17962 Z_695) (take_19 nil_97 x_17962 nil_97))))
...
(assert (forall ((x_17980 list_90) (x_17965 Int) (x_17966 list_90) (z_691 Int) (x_17964 list_90))
	(=> (and (<= z_691 x_17965) (lmerge_2 x_17980 x_17964 (cons_90 x_17965 x_17966))) (lmerge_2 (cons_90 z_691 x_17980) (cons_90 z_691 x_17964) (cons_90 x_17965 x_17966)))))
(assert (forall ((x_17982 list_90) (x_17965 Int) (x_17966 list_90) (z_691 Int) (x_17964 list_90))
	(=> (and (> z_691 x_17965) (lmerge_2 x_17982 (cons_90 z_691 x_17964) x_17966)) (lmerge_2 (cons_90 x_17965 x_17982) (cons_90 z_691 x_17964) (cons_90 x_17965 x_17966)))))
...
(assert (forall ((z_692 Int) (xs_205 list_90) (x_17968 Int))
	(=> (<= x_17968 z_692) (insert_4 (cons_90 x_17968 (cons_90 z_692 xs_205)) x_17968 (cons_90 z_692 xs_205)))))
(assert (forall ((x_17990 list_90) (z_692 Int) (xs_205 list_90) (x_17968 Int))
	(=> (and (> x_17968 z_692) (insert_4 x_17990 x_17968 xs_205)) (insert_4 (cons_90 z_692 x_17990) x_17968 (cons_90 z_692 xs_205)))))
...
(assert (forall ((x_17996 list_90) (x_17970 Int))
	(=> (<= x_17970 Z_695) (drop_21 x_17996 x_17970 x_17996))))
(assert (forall ((x_18015 Int) (x_17997 list_90) (z_693 Int) (xs_207 list_90) (x_17970 Int))
	(=> (and (> x_17970 Z_695) (drop_21 x_17997 x_18015 xs_207) (minus_126 x_18015 x_17970 (S_205 Z_695))) (drop_21 x_17997 x_17970 (cons_90 z_693 xs_207)))))
(assert (forall ((x_17999 list_90) (x_17970 Int))
	(=> (<= x_17970 Z_695) (drop_21 x_17999 x_17970 x_17999))))
(assert (forall ((x_17970 Int))
	(=> (> x_17970 Z_695) (drop_21 nil_97 x_17970 nil_97))))

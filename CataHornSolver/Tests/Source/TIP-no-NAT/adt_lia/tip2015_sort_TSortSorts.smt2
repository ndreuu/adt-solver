...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (le_105 x y))))
(assert (forall ((y_510 Int))
	(ge_105 y_510 Z_566)))
...
(assert (forall ((x Int) (y Int)) (=> (> x y) (gt_106 x y))))
(assert (forall ((y_510 Int))
...
(assert (forall ((x_12234 Int) (x_12235 list_81) (x_12236 Int) (x_12237 list_81))
	(=> (distinct x_12234 x_12236) (diseqlist_81 (cons_81 x_12234 x_12235) (cons_81 x_12236 x_12237)))))
(assert (forall ((x_12234 Int) (x_12235 list_81) (x_12236 Int) (x_12237 list_81))
...
(assert (forall ((x_12252 Tree_1) (x_12253 Int) (x_12254 Tree_1) (x_12255 Tree_1) (x_12256 Int) (x_12257 Tree_1))
	(=> (distinct x_12253 x_12256) (diseqTree_1 (TNode_0 x_12252 x_12253 x_12254) (TNode_0 x_12255 x_12256 x_12257)))))
(assert (forall ((x_12252 Tree_1) (x_12253 Int) (x_12254 Tree_1) (x_12255 Tree_1) (x_12256 Int) (x_12257 Tree_1))
...
(assert (forall ((x_12211 list_81) (xs_169 list_81))
	(=> (and (tsort_0 x_12211 xs_169) (ordered_2 false_105 x_12211)) false)))
(check-sat)

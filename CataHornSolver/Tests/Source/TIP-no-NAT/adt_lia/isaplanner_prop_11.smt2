...
(assert (forall ((x_3114 Int) (x_3115 list_52) (x_3116 Int) (x_3117 list_52))
	(=> (distinct x_3114 x_3116) (diseqlist_52 (cons_52 x_3114 x_3115) (cons_52 x_3116 x_3117)))))
(assert (forall ((x_3114 Int) (x_3115 list_52) (x_3116 Int) (x_3117 list_52))
...
(assert (forall ((x_3098 list_52) (x_3096 Int) (x_3097 list_52) (z_318 Int))
	(=> (and (>= z_318 0) (drop_11 x_3098 z_318 x_3097)) (drop_11 x_3098 (S_112 z_318) (cons_52 x_3096 x_3097)))))
(assert (forall ((z_318 Int))
	(drop_11 nil_52 z_318 nil_52)))

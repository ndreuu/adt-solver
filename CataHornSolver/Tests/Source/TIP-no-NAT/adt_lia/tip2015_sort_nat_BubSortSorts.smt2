...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_41 true_265 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_41 false_265 x y))))
...
(assert (forall ((x_49886 list_194) (xs_529 list_194))
	(=> (and (bubsort_4 x_49886 xs_529) (ordered_18 false_265 x_49886)) false)))
(check-sat)

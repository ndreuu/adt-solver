...
(assert (forall ((x_2739 Int) (x_2740 Int) (x_2741 Int) (x_2742 Int))
	(=> (distinct x_2739 x_2741) (diseqpair_8 (pair_17 x_2739 x_2740) (pair_17 x_2741 x_2742)))))
(assert (forall ((x_2739 Int) (x_2740 Int) (x_2741 Int) (x_2742 Int))
	(=> (distinct x_2740 x_2742) (diseqpair_8 (pair_17 x_2739 x_2740) (pair_17 x_2741 x_2742)))))
...
(assert (forall ((x_2753 Int) (x_2754 list_45) (x_2755 Int) (x_2756 list_45))
	(=> (distinct x_2753 x_2755) (diseqlist_45 (cons_45 x_2753 x_2754) (cons_45 x_2755 x_2756)))))
(assert (forall ((x_2753 Int) (x_2754 list_45) (x_2755 Int) (x_2756 list_45))

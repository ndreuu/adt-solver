...
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (add_166 z x y))))
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_160 z x y))))
...
(assert (forall ((x_22783 Int) (y_902 Int))
	(=> (< x_22783 y_902) (div_156 Z_888 x_22783 y_902))))
(assert (forall ((x_22783 Int) (y_902 Int) (r_186 Int) (z_889 Int))
	(=> (and (>= x_22783 y_902) (minus_160 z_889 x_22783 y_902) (div_156 r_186 z_889 y_902)) (div_156 (S_244 r_186) x_22783 y_902))))
(assert (forall ((x_22783 Int) (y_902 Int))
	(=> (< x_22783 y_902) (mod_156 x_22783 x_22783 y_902))))
(assert (forall ((x_22783 Int) (y_902 Int) (r_186 Int) (z_889 Int))
	(=> (and (>= x_22783 y_902) (minus_160 z_889 x_22783 y_902) (mod_156 r_186 z_889 y_902)) (mod_156 r_186 x_22783 y_902))))
...
(assert (forall ((x_22807 Int) (x_22808 list_112) (x_22809 Int) (x_22810 list_112))
	(=> (distinct x_22807 x_22809) (diseqlist_112 (cons_112 x_22807 x_22808) (cons_112 x_22809 x_22810)))))
(assert (forall ((x_22807 Int) (x_22808 list_112) (x_22809 Int) (x_22810 list_112))
...
(assert (=> (distinct (S_244 Z_888) (S_244 (S_244 Z_888))) (third_2 Z_888 (S_244 Z_888))))
(assert (third_2 Z_888 (S_244 (S_244 Z_888))))
(assert (=> (and (distinct Z_888 (S_244 (S_244 Z_888))) (distinct Z_888 (S_244 Z_888))) (third_2 Z_888 Z_888)))
(assert (third_2 Z_888 (S_244 (S_244 Z_888))))
(assert (=> (distinct (S_244 Z_888) (S_244 (S_244 Z_888))) (third_2 Z_888 (S_244 Z_888))))
(assert (third_2 Z_888 (S_244 (S_244 Z_888))))
(assert (forall ((x_22785 Int) (x_22724 Int) (x_22725 Int) (x_22700 Int))
	(=> (and (distinct x_22700 (S_244 (S_244 Z_888))) (distinct x_22700 (S_244 Z_888)) (distinct x_22700 Z_888) (third_2 x_22725 x_22785) (minus_160 x_22785 x_22700 (S_244 (S_244 (S_244 Z_888)))) (add_166 x_22724 (S_244 Z_888) x_22725)) (third_2 x_22724 x_22700))))
(declare-fun take_23 (list_112 Int list_112) Bool)
(assert (forall ((x_22701 Int) (y_891 list_112))
	(=> (<= x_22701 Z_888) (take_23 nil_124 x_22701 y_891))))
(assert (forall ((x_22786 Int) (x_22728 list_112) (z_883 Int) (xs_274 list_112) (x_22701 Int))
	(=> (and (> x_22701 Z_888) (take_23 x_22728 x_22786 xs_274) (minus_160 x_22786 x_22701 (S_244 Z_888))) (take_23 (cons_112 z_883 x_22728) x_22701 (cons_112 z_883 xs_274)))))
(assert (forall ((x_22701 Int) (y_891 list_112))
	(=> (<= x_22701 Z_888) (take_23 nil_124 x_22701 y_891))))
(assert (forall ((x_22701 Int))
	(=> (> x_22701 Z_888) (take_23 nil_124 x_22701 nil_124))))
(declare-fun sort_12 (list_112 Int Int) Bool)
(assert (forall ((x_22702 Int) (y_892 Int))
	(=> (<= x_22702 y_892) (sort_12 (cons_112 x_22702 (cons_112 y_892 nil_124)) x_22702 y_892))))
(assert (forall ((x_22702 Int) (y_892 Int))
	(=> (> x_22702 y_892) (sort_12 (cons_112 y_892 (cons_112 x_22702 nil_124)) x_22702 y_892))))
...
(assert (forall ((z_884 Int) (xs_275 list_112) (x_22704 Int))
	(=> (<= x_22704 z_884) (insert_10 (cons_112 x_22704 (cons_112 z_884 xs_275)) x_22704 (cons_112 z_884 xs_275)))))
(assert (forall ((x_22738 list_112) (z_884 Int) (xs_275 list_112) (x_22704 Int))
	(=> (and (> x_22704 z_884) (insert_10 x_22738 x_22704 xs_275)) (insert_10 (cons_112 z_884 x_22738) x_22704 (cons_112 z_884 xs_275)))))
...
(assert (forall ((x_22744 list_112) (x_22706 Int))
	(=> (<= x_22706 Z_888) (drop_25 x_22744 x_22706 x_22744))))
(assert (forall ((x_22788 Int) (x_22745 list_112) (z_885 Int) (xs_277 list_112) (x_22706 Int))
	(=> (and (> x_22706 Z_888) (drop_25 x_22745 x_22788 xs_277) (minus_160 x_22788 x_22706 (S_244 Z_888))) (drop_25 x_22745 x_22706 (cons_112 z_885 xs_277)))))
(assert (forall ((x_22747 list_112) (x_22706 Int))
	(=> (<= x_22706 Z_888) (drop_25 x_22747 x_22706 x_22747))))
(assert (forall ((x_22706 Int))
	(=> (> x_22706 Z_888) (drop_25 nil_124 x_22706 nil_124))))
...
(assert (forall ((x_22781 list_112) (x_22782 list_112) (xs_280 list_112))
	(=> (and (diseqlist_112 x_22781 x_22782) (nstoogesort_7 x_22781 xs_280) (isort_10 x_22782 xs_280)) false)))
(check-sat)

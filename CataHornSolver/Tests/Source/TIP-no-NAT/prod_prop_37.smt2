...
(assert (forall ((x_55401 Int) (x_55402 list_244) (x_55403 Int) (x_55404 list_244))
	(=> (distinct x_55401 x_55403) (diseqlist_244 (cons_244 x_55401 x_55402) (cons_244 x_55403 x_55404)))))
(assert (forall ((x_55401 Int) (x_55402 list_244) (x_55403 Int) (x_55404 list_244))
...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (x_55355 false_342 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (x_55355 true_342 x y))))
...
(assert (forall ((x_55377 list_244) (x_55361 Int) (y_2293 list_244) (z_2059 list_244))
	(=> (and (elem_19 true_342 x_55361 z_2059) (x_55359 x_55377 y_2293 z_2059) (elem_19 false_342 x_55361 x_55377)) false)))
(check-sat)

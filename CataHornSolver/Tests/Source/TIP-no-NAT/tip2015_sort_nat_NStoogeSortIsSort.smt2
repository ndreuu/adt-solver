...
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (plus_81 z x y))))
(declare-fun minus_233 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_233 z x y))))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_32 true_221 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_32 false_221 x y))))
...
(assert (forall ((x_35125 Int) (x_35126 Int) (x_35127 Int) (x_35128 Int) (x_35041 Int) (y_1425 Int) (z_1316 Int))
	(=> (and (distinct x_35126 x_35128) (plus_81 x_35125 y_1425 z_1316) (plus_81 x_35126 x_35041 x_35125) (plus_81 x_35127 x_35041 y_1425) (plus_81 x_35128 x_35127 z_1316)) false)))
(assert (forall ((x_35129 Int) (x_35130 Int) (x_35042 Int) (y_1426 Int))
	(=> (and (distinct x_35129 x_35130) (plus_81 x_35129 x_35042 y_1426) (plus_81 x_35130 y_1426 x_35042)) false)))
(assert (forall ((x_35131 Int) (x_35043 Int))
	(=> (and (distinct x_35131 x_35043) (plus_81 x_35131 x_35043 zero_89)) false)))
(assert (forall ((x_35132 Int) (x_35044 Int))
	(=> (and (distinct x_35132 x_35044) (plus_81 x_35132 zero_89 x_35044)) false)))
(assert (forall ((x_35133 list_151) (x_35134 list_151) (xs_420 list_151))
	(=> (and (diseqlist_151 x_35133 x_35134) (nstoogesort_19 x_35133 xs_420) (isort_18 x_35134 xs_420)) false)))
(check-sat)

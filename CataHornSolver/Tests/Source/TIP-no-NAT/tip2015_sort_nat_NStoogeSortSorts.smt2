...
(assert (forall ((x_51400 Int) (x_51401 list_202) (x_51402 Int) (x_51403 list_202))
	(=> (distinct x_51400 x_51402) (diseqlist_202 (cons_202 x_51400 x_51401) (cons_202 x_51402 x_51403)))))
(assert (forall ((x_51400 Int) (x_51401 list_202) (x_51402 Int) (x_51403 list_202))
...
(assert (forall ((x_51294 list_202) (z_1707 Int) (xs_548 list_202) (z_1706 Int))
	(=> (and (>= z_1706 0) (take_44 x_51294 z_1706 xs_548)) (take_44 (cons_202 z_1707 x_51294) (succ_123 z_1706) (cons_202 z_1707 xs_548)))))
(assert (forall ((z_1706 Int))
	(take_44 nil_230 z_1706 nil_230)))
(assert (forall ((z Int) (y_1910 list_202))
	(=> (<= z 0) (take_44 nil_230 z y_1910))))
(declare-fun plus_120 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (plus_120 z x y))))
(declare-fun minus_300 (Int Int Int) Bool)
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_300 z x y))))
(declare-fun third_10 (Int Int) Bool)
(assert (third_10 zero_126 (succ_123 (succ_123 zero_126))))
(assert (=> (distinct (succ_123 zero_126) (succ_123 (succ_123 zero_126))) (third_10 zero_126 (succ_123 zero_126))))
(assert (third_10 zero_126 (succ_123 (succ_123 zero_126))))
(assert (forall ((x_51307 Int) (x_51308 Int) (x_51309 Int) (y_1914 Int))
	(=> (and (distinct (succ_123 y_1914) (succ_123 (succ_123 zero_126))) (distinct (succ_123 y_1914) (succ_123 zero_126)) (minus_300 x_51308 (succ_123 y_1914) (succ_123 (succ_123 (succ_123 zero_126)))) (third_10 x_51309 x_51308) (plus_120 x_51307 (succ_123 zero_126) x_51309)) (third_10 x_51307 (succ_123 y_1914)))))
(assert (third_10 zero_126 (succ_123 (succ_123 zero_126))))
(assert (=> (distinct (succ_123 zero_126) (succ_123 (succ_123 zero_126))) (third_10 zero_126 (succ_123 zero_126))))
(assert (third_10 zero_126 (succ_123 (succ_123 zero_126))))
(assert (=> (and (distinct zero_126 (succ_123 (succ_123 zero_126))) (distinct zero_126 (succ_123 zero_126))) (third_10 zero_126 zero_126)))
(declare-fun leq_48 (Bool_283 Int Int) Bool)
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_48 true_283 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_48 false_283 x y))))
...
(assert (forall ((x_51328 Int) (x_51329 Int) (y_1919 Int) (l_36 list_202))
	(=> (and (>= x_51329 0) (length_34 x_51329 l_36) (plus_120 x_51328 (succ_123 zero_126) x_51329)) (length_34 x_51328 (cons_202 y_1919 l_36)))))
(assert (forall ((z Int)) (=> (<= z 0) (length_34 z nil_230))))
(declare-fun drop_46 (list_202 Int list_202) Bool)
(assert (forall ((x_51332 list_202) (z_1713 Int) (xs_550 list_202) (z_1712 Int))
	(=> (and (>= z_1712 0) (drop_46 x_51332 z_1712 xs_550)) (drop_46 x_51332 (succ_123 z_1712) (cons_202 z_1713 xs_550)))))
(assert (forall ((z_1712 Int))
	(drop_46 nil_230 z_1712 nil_230)))
(assert (forall ((z Int) (x_51335 list_202))
	(=> (<= z 0) (drop_46 x_51335 z x_51335))))
...
(assert (forall ((x_51368 Int) (x_51369 Int) (x_51370 Int) (x_51371 Int) (x_51289 Int) (y_1926 Int) (z_1716 Int))
	(=> (and (distinct x_51369 x_51371) (plus_120 x_51368 y_1926 z_1716) (plus_120 x_51369 x_51289 x_51368) (plus_120 x_51370 x_51289 y_1926) (plus_120 x_51371 x_51370 z_1716)) false)))
(assert (forall ((x_51372 Int) (x_51373 Int) (x_51290 Int) (y_1927 Int))
	(=> (and (distinct x_51372 x_51373) (plus_120 x_51372 x_51290 y_1927) (plus_120 x_51373 y_1927 x_51290)) false)))
(assert (forall ((x_51374 Int) (x_51291 Int))
	(=> (and (distinct x_51374 x_51291) (plus_120 x_51374 x_51291 zero_126)) false)))
(assert (forall ((x_51375 Int) (x_51292 Int))
	(=> (and (distinct x_51375 x_51292) (plus_120 x_51375 zero_126 x_51292)) false)))
(assert (forall ((x_51376 list_202) (xs_553 list_202))
	(=> (and (nstoogesort_31 x_51376 xs_553) (ordered_22 false_283 x_51376)) false)))
(check-sat)
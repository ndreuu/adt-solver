...
(assert (forall ((x_2394 Int) (x_2395 list_40) (x_2396 Int) (x_2397 list_40))
	(=> (distinct x_2394 x_2396) (diseqlist_40 (cons_40 x_2394 x_2395) (cons_40 x_2396 x_2397)))))
(assert (forall ((x_2394 Int) (x_2395 list_40) (x_2396 Int) (x_2397 list_40))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (x_2341 true_44 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (x_2341 false_44 x y))))

...
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (add_185 z x y))))
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_179 z x y))))
...
(assert (forall ((x_26439 Int) (y_1047 Int))
	(=> (< x_26439 y_1047) (div_174 Z_1005 x_26439 y_1047))))
(assert (forall ((x_26439 Int) (y_1047 Int) (r_207 Int) (z_1006 Int))
	(=> (and (>= x_26439 y_1047) (minus_179 z_1006 x_26439 y_1047) (div_174 r_207 z_1006 y_1047)) (div_174 (S_265 r_207) x_26439 y_1047))))
(assert (forall ((x_26439 Int) (y_1047 Int))
	(=> (< x_26439 y_1047) (mod_174 x_26439 x_26439 y_1047))))
(assert (forall ((x_26439 Int) (y_1047 Int) (r_207 Int) (z_1006 Int))
	(=> (and (>= x_26439 y_1047) (minus_179 z_1006 x_26439 y_1047) (mod_174 r_207 z_1006 y_1047)) (mod_174 r_207 x_26439 y_1047))))
...
(assert (forall ((x_26458 Int) (x_26459 list_123) (x_26460 Int) (x_26461 list_123))
	(=> (distinct x_26458 x_26460) (diseqlist_123 (cons_123 x_26458 x_26459) (cons_123 x_26460 x_26461)))))
(assert (forall ((x_26458 Int) (x_26459 list_123) (x_26460 Int) (x_26461 list_123))
...
(assert (forall ((x_26476 Heap_4) (x_26477 Int) (x_26478 Heap_4) (x_26479 Heap_4) (x_26480 Int) (x_26481 Heap_4))
	(=> (distinct x_26477 x_26480) (diseqHeap_4 (Node_7 x_26476 x_26477 x_26478) (Node_7 x_26479 x_26480 x_26481)))))
(assert (forall ((x_26476 Heap_4) (x_26477 Int) (x_26478 Heap_4) (x_26479 Heap_4) (x_26480 Int) (x_26481 Heap_4))
...
(assert (forall ((z_1003 Int) (xs_327 list_123) (x_26398 Int))
	(=> (<= x_26398 z_1003) (insert_14 (cons_123 x_26398 (cons_123 z_1003 xs_327)) x_26398 (cons_123 z_1003 xs_327)))))
(assert (forall ((x_26412 list_123) (z_1003 Int) (xs_327 list_123) (x_26398 Int))
	(=> (and (> x_26398 z_1003) (insert_14 x_26412 x_26398 xs_327)) (insert_14 (cons_123 z_1003 x_26412) x_26398 (cons_123 z_1003 xs_327)))))
...
(assert (forall ((x_26421 Heap_4) (x_26403 Heap_4) (x_26404 Int) (x_26405 Heap_4) (z_1004 Heap_4) (x_26401 Int) (x_26402 Heap_4))
	(=> (and (<= x_26401 x_26404) (hmerge_4 x_26421 x_26402 (Node_7 x_26403 x_26404 x_26405))) (hmerge_4 (Node_7 x_26421 x_26401 z_1004) (Node_7 z_1004 x_26401 x_26402) (Node_7 x_26403 x_26404 x_26405)))))
(assert (forall ((x_26423 Heap_4) (x_26403 Heap_4) (x_26404 Int) (x_26405 Heap_4) (z_1004 Heap_4) (x_26401 Int) (x_26402 Heap_4))
	(=> (and (> x_26401 x_26404) (hmerge_4 x_26423 (Node_7 z_1004 x_26401 x_26402) x_26405)) (hmerge_4 (Node_7 x_26423 x_26404 x_26403) (Node_7 z_1004 x_26401 x_26402) (Node_7 x_26403 x_26404 x_26405)))))
...
(assert (forall ((x_26437 list_123) (x_26438 list_123) (xs_330 list_123))
	(=> (and (diseqlist_123 x_26437 x_26438) (hsort_4 x_26437 xs_330) (isort_14 x_26438 xs_330)) false)))
(check-sat)

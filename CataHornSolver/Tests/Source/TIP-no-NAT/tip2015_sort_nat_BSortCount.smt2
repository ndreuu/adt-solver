...
(assert (forall ((x_25665 Int) (x_25666 list_119) (x_25667 Int) (x_25668 list_119))
	(=> (distinct x_25665 x_25667) (diseqlist_119 (cons_119 x_25665 x_25666) (cons_119 x_25667 x_25668)))))
(assert (forall ((x_25665 Int) (x_25666 list_119) (x_25667 Int) (x_25668 list_119))
...
(assert (forall ((x_25583 Int) (z_940 Int) (ys_92 list_119) (x_25539 Int))
	(=> (and (distinct x_25539 z_940) (count_19 x_25583 x_25539 ys_92)) (count_19 x_25583 x_25539 (cons_119 z_940 ys_92)))))
...
(assert (forall ((x_25633 Int) (x_25634 Int) (x_25635 Int) (x_25636 Int) (x_25558 Int) (y_972 Int) (z_946 Int))
	(=> (and (distinct x_25634 x_25636) (plus_51 x_25633 y_972 z_946) (plus_51 x_25634 x_25558 x_25633) (plus_51 x_25635 x_25558 y_972) (plus_51 x_25636 x_25635 z_946)) false)))
(assert (forall ((x_25637 Int) (x_25638 Int) (x_25559 Int) (y_973 Int))
	(=> (and (distinct x_25637 x_25638) (plus_51 x_25637 x_25559 y_973) (plus_51 x_25638 y_973 x_25559)) false)))
(assert (forall ((x_25639 Int) (x_25560 Int))
	(=> (and (distinct x_25639 x_25560) (plus_51 x_25639 x_25560 zero_52)) false)))
(assert (forall ((x_25640 Int) (x_25561 Int))
	(=> (and (distinct x_25640 x_25561) (plus_51 x_25640 zero_52 x_25561)) false)))
(assert (forall ((x_25641 list_119) (x_25642 Int) (x_25643 Int) (x_25562 Int) (xs_308 list_119))
	(=> (and (distinct x_25642 x_25643) (bsort_4 x_25641 xs_308) (count_19 x_25642 x_25562 x_25641) (count_19 x_25643 x_25562 xs_308)) false)))
(check-sat)

...
(assert (forall ((x_76107 Int) (x_76108 Int) (x_76109 Int) (x_76110 Int))
	(=> (distinct x_76107 x_76109) (diseqpair_64 (pair_129 x_76107 x_76108) (pair_129 x_76109 x_76110)))))
(assert (forall ((x_76107 Int) (x_76108 Int) (x_76109 Int) (x_76110 Int))
	(=> (distinct x_76108 x_76110) (diseqpair_64 (pair_129 x_76107 x_76108) (pair_129 x_76109 x_76110)))))
...
(assert (forall ((x_76135 Int) (x_76136 list_325) (x_76137 Int) (x_76138 list_325))
	(=> (distinct x_76135 x_76137) (diseqlist_321 (cons_321 x_76135 x_76136) (cons_321 x_76137 x_76138)))))
(assert (forall ((x_76135 Int) (x_76136 list_325) (x_76137 Int) (x_76138 list_325))
...
(assert (forall ((x_76173 Int) (x_76174 Int))
	(=> (distinct x_76173 x_76174) (diseqMaybe_10 (Just_10 x_76173) (Just_10 x_76174)))))
...
(assert (forall ((x_76087 Int) (x_76024 Maybe_10) (z_2406 Int) (xs_803 list_325) (y_2709 Int))
	(=> (and (distinct y_2709 Z_2410) (index_2 x_76024 xs_803 x_76087) (minus_421 x_76087 y_2709 (S_561 Z_2410))) (index_2 x_76024 (cons_321 z_2406 xs_803) y_2709))))
...
(assert (forall ((x_76039 list_324) (c_44 Int) (c_43 Int) (u_13 Int) (v_13 Int) (z_2408 list_326) (a_81 list_325))
	(=> (and (distinct c_43 c_44) (colouring_4 x_76039 a_81 z_2408) (index_2 (Just_10 c_44) a_81 v_13) (index_2 (Just_10 c_43) a_81 u_13)) (colouring_4 (cons_320 true_400 x_76039) a_81 (cons_322 (pair_129 u_13 v_13) z_2408)))))

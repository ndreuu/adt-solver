...
(assert (forall ((x_55159 Int) (x_55160 list_240) (x_55161 Int) (x_55162 list_240))
	(=> (distinct x_55159 x_55161) (diseqlist_240 (cons_240 x_55159 x_55160) (cons_240 x_55161 x_55162)))))
(assert (forall ((x_55159 Int) (x_55160 list_240) (x_55161 Int) (x_55162 list_240))
...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (x_55110 false_337 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (x_55110 true_337 x y))))
...
(assert (forall ((x_55135 list_240) (x_55115 Int) (y_2267 list_240) (z_2033 list_240))
	(=> (and (elem_17 true_337 x_55115 y_2267) (union_1 x_55135 z_2033 y_2267) (elem_17 false_337 x_55115 x_55135)) false)))
(check-sat)

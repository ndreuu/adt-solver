...
(assert (forall ((x_2329 Int) (x_2330 list_39) (x_2331 Int) (x_2332 list_39))
	(=> (distinct x_2329 x_2331) (diseqlist_39 (cons_39 x_2329 x_2330) (cons_39 x_2331 x_2332)))))
(assert (forall ((x_2329 Int) (x_2330 list_39) (x_2331 Int) (x_2332 list_39))
...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (x_2285 false_43 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (x_2285 true_43 x y))))
...
(assert (forall ((x_2306 list_39) (x_2291 Int) (xs_68 list_39))
	(=> (and (x_2289 x_2306 xs_68 (cons_39 x_2291 nil_39)) (elem_4 false_43 x_2291 x_2306)) false)))
(check-sat)

...
(assert (forall ((x_27969 Int) (x_27970 list_132) (x_27971 Int) (x_27972 list_132))
	(=> (distinct x_27969 x_27971) (diseqlist_132 (cons_132 x_27969 x_27970) (cons_132 x_27971 x_27972)))))
(assert (forall ((x_27969 Int) (x_27970 list_132) (x_27971 Int) (x_27972 list_132))
...
(assert (=> (distinct (S_279 Z_1093) (S_279 (S_279 Z_1093))) (twoThirds_1 (S_279 Z_1093) (S_279 Z_1093))))
(assert (twoThirds_1 (S_279 Z_1093) (S_279 (S_279 Z_1093))))
(assert (=> (and (distinct Z_1093 (S_279 (S_279 Z_1093))) (distinct Z_1093 (S_279 Z_1093))) (twoThirds_1 Z_1093 Z_1093)))
(assert (twoThirds_1 (S_279 Z_1093) (S_279 (S_279 Z_1093))))
(assert (=> (distinct (S_279 Z_1093) (S_279 (S_279 Z_1093))) (twoThirds_1 (S_279 Z_1093) (S_279 Z_1093))))
(assert (twoThirds_1 (S_279 Z_1093) (S_279 (S_279 Z_1093))))
(assert (forall ((x_27944 Int) (x_27882 Int) (x_27883 Int) (x_27858 Int))
	(=> (and (distinct x_27858 (S_279 (S_279 Z_1093))) (distinct x_27858 (S_279 Z_1093)) (distinct x_27858 Z_1093) (twoThirds_1 x_27883 x_27944) (minus_194 x_27944 x_27858 (S_279 (S_279 (S_279 Z_1093)))) (add_202 x_27882 (S_279 (S_279 Z_1093)) x_27883)) (twoThirds_1 x_27882 x_27858))))
(declare-fun third_3 (Int Int) Bool)
(assert (third_3 Z_1093 (S_279 (S_279 Z_1093))))
(assert (=> (distinct (S_279 Z_1093) (S_279 (S_279 Z_1093))) (third_3 Z_1093 (S_279 Z_1093))))
(assert (third_3 Z_1093 (S_279 (S_279 Z_1093))))
(assert (=> (and (distinct Z_1093 (S_279 (S_279 Z_1093))) (distinct Z_1093 (S_279 Z_1093))) (third_3 Z_1093 Z_1093)))
(assert (third_3 Z_1093 (S_279 (S_279 Z_1093))))
(assert (=> (distinct (S_279 Z_1093) (S_279 (S_279 Z_1093))) (third_3 Z_1093 (S_279 Z_1093))))
(assert (third_3 Z_1093 (S_279 (S_279 Z_1093))))
(assert (forall ((x_27946 Int) (x_27891 Int) (x_27892 Int) (x_27859 Int))
	(=> (and (distinct x_27859 (S_279 (S_279 Z_1093))) (distinct x_27859 (S_279 Z_1093)) (distinct x_27859 Z_1093) (third_3 x_27892 x_27946) (minus_194 x_27946 x_27859 (S_279 (S_279 (S_279 Z_1093)))) (add_202 x_27891 (S_279 Z_1093) x_27892)) (third_3 x_27891 x_27859))))
...
(assert (forall ((x_27913 Int) (z_1090 Int) (ys_112 list_132) (x_27865 Int))
	(=> (and (distinct x_27865 z_1090) (count_22 x_27913 x_27865 ys_112)) (count_22 x_27913 x_27865 (cons_132 z_1090 ys_112)))))

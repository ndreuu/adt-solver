...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (le_278 x y))))
(assert (forall ((y_1883 Int))
...
(assert (forall ((x Int) (y Int)) (=> (> x y) (gt_281 x y))))
(assert (forall ((y_1883 Int))
...
(assert (forall ((x_50845 Int) (x_50846 list_199) (x_50847 Int) (x_50848 list_199))
	(=> (distinct x_50845 x_50847) (diseqlist_199 (cons_199 x_50845 x_50846) (cons_199 x_50847 x_50848)))))
(assert (forall ((x_50845 Int) (x_50846 list_199) (x_50847 Int) (x_50848 list_199))
...
(assert (forall ((x_50863 Heap_10) (x_50864 Int) (x_50865 Heap_10) (x_50866 Heap_10) (x_50867 Int) (x_50868 Heap_10))
	(=> (distinct x_50864 x_50867) (diseqHeap_10 (Node_14 x_50863 x_50864 x_50865) (Node_14 x_50866 x_50867 x_50868)))))
(assert (forall ((x_50863 Heap_10) (x_50864 Int) (x_50865 Heap_10) (x_50866 Heap_10) (x_50867 Int) (x_50868 Heap_10))
...
(assert (forall ((x_50822 list_199) (xs_542 list_199))
	(=> (and (hsort_10 x_50822 xs_542) (ordered_21 false_278 x_50822)) false)))
(check-sat)

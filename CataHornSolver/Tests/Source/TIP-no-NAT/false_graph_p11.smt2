...
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (+ x y)) (add_454 z x y))))
(assert (forall ((z Int) (x Int) (y Int)) (=> (= z (- x y)) (minus_445 z x y))))
...
(assert (forall ((x_108987 Int) (x_108988 Int) (x_108989 Int) (x_108990 Int))
	(=> (distinct x_108987 x_108989) (diseqpair_87 (pair_175 x_108987 x_108988) (pair_175 x_108989 x_108990)))))
(assert (forall ((x_108987 Int) (x_108988 Int) (x_108989 Int) (x_108990 Int))
	(=> (distinct x_108988 x_108990) (diseqpair_87 (pair_175 x_108987 x_108988) (pair_175 x_108989 x_108990)))))
...
(assert (forall ((x_109015 Int) (x_109016 list_372) (x_109017 Int) (x_109018 list_372))
	(=> (distinct x_109015 x_109017) (diseqlist_366 (cons_366 x_109015 x_109016) (cons_366 x_109017 x_109018)))))
(assert (forall ((x_109015 Int) (x_109016 list_372) (x_109017 Int) (x_109018 list_372))
...
(assert (forall ((x_109053 Int) (x_109054 Int))
	(=> (distinct x_109053 x_109054) (diseqMaybe_21 (Just_21 x_109053) (Just_21 x_109054)))))
(declare-fun primEnumFromTo_10 (list_372 Int Int) Bool)
(assert (forall ((x_108876 Int) (y_3007 Int))
	(=> (> x_108876 y_3007) (primEnumFromTo_10 nil_424 x_108876 y_3007))))
(assert (forall ((x_108962 Int) (x_108893 list_372) (x_108876 Int) (y_3007 Int))
	(=> (and (<= x_108876 y_3007) (primEnumFromTo_10 x_108893 x_108962 y_3007) (add_454 x_108962 (S_601 Z_2613) x_108876)) (primEnumFromTo_10 (cons_366 x_108876 x_108893) x_108876 y_3007))))
...
(assert (forall ((x_108967 Int) (x_108904 Maybe_21) (z_2609 Int) (xs_862 list_372) (y_3011 Int))
	(=> (and (distinct y_3011 Z_2613) (index_5 x_108904 xs_862 x_108967) (minus_445 x_108967 y_3011 (S_601 Z_2613))) (index_5 x_108904 (cons_366 z_2609 xs_862) y_3011))))
...
(assert (forall ((x_108908 list_371) (y_3012 Int) (z_2610 list_372))
	(=> (and (< y_3012 (S_601 (S_601 (S_601 Z_2613)))) (formula_9 x_108908 z_2610)) (formula_9 (cons_365 true_424 x_108908) (cons_366 y_3012 z_2610)))))
(assert (forall ((x_108910 list_371) (y_3012 Int) (z_2610 list_372))
	(=> (and (>= y_3012 (S_601 (S_601 (S_601 Z_2613)))) (formula_9 x_108910 z_2610)) (formula_9 (cons_365 false_424 x_108910) (cons_366 y_3012 z_2610)))))
...
(assert (forall ((x_108919 list_371) (c_67 Int) (c_66 Int) (u_26 Int) (v_26 Int) (z_2611 list_373) (a_112 list_372))
	(=> (and (distinct c_66 c_67) (colouring_10 x_108919 a_112 z_2611) (index_5 (Just_21 c_67) a_112 v_26) (index_5 (Just_21 c_66) a_112 u_26)) (colouring_10 (cons_365 true_424 x_108919) a_112 (cons_367 (pair_175 u_26 v_26) z_2611)))))

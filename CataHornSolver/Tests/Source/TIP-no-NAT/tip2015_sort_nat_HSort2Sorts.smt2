...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_47 true_277 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_47 false_277 x y))))
...
(assert (forall ((x_50718 list_198) (xs_540 list_198))
	(=> (and (hsort_9 x_50718 xs_540) (ordered_20 false_277 x_50718)) false)))
(check-sat)

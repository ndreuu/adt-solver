...
(assert (forall ((x Int) (y Int))
	(=> (distinct x y) (x_1225 false_22 x y))))
(assert (forall ((x Int) (y Int))
	(=> (= x y) (x_1225 true_22 x y))))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (x_1229 true_22 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (x_1229 false_22 x y))))

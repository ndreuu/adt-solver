...
(assert (forall ((x_12136 Int) (x_12137 list_80) (x_12138 Int) (x_12139 list_80))
	(=> (distinct x_12136 x_12138) (diseqlist_80 (cons_80 x_12136 x_12137) (cons_80 x_12138 x_12139)))))
(assert (forall ((x_12136 Int) (x_12137 list_80) (x_12138 Int) (x_12139 list_80))
...
(assert (forall ((x_12072 Int) (z_553 Int) (ys_41 list_80) (x_12014 Int))
	(=> (and (distinct x_12014 z_553) (count_12 x_12072 x_12014 ys_41)) (count_12 x_12072 x_12014 (cons_80 z_553 ys_41)))))
...
(assert (forall ((x_12104 Int) (x_12105 Int) (x_12106 Int) (x_12107 Int) (x_12024 Int) (y_499 Int) (z_556 Int))
	(=> (and (distinct x_12105 x_12107) (plus_13 x_12104 y_499 z_556) (plus_13 x_12105 x_12024 x_12104) (plus_13 x_12106 x_12024 y_499) (plus_13 x_12107 x_12106 z_556)) false)))
(assert (forall ((x_12108 Int) (x_12109 Int) (x_12025 Int) (y_500 Int))
	(=> (and (distinct x_12108 x_12109) (plus_13 x_12108 x_12025 y_500) (plus_13 x_12109 y_500 x_12025)) false)))
(assert (forall ((x_12110 Int) (x_12026 Int))
	(=> (and (distinct x_12110 x_12026) (plus_13 x_12110 x_12026 zero_15)) false)))
(assert (forall ((x_12111 Int) (x_12027 Int))
	(=> (and (distinct x_12111 x_12027) (plus_13 x_12111 zero_15 x_12027)) false)))
(assert (forall ((x_12112 list_80) (x_12113 Int) (x_12114 Int) (x_12028 Int) (xs_166 list_80))
	(=> (and (distinct x_12113 x_12114) (stoogesort_1 x_12112 xs_166) (count_12 x_12113 x_12028 x_12112) (count_12 x_12114 x_12028 xs_166)) false)))
(check-sat)

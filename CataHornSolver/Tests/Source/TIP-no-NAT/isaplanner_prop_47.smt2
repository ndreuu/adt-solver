...
(assert (forall ((x_3708 Tree_0) (x_3709 Int) (x_3710 Tree_0) (x_3711 Tree_0) (x_3712 Int) (x_3713 Tree_0))
	(=> (distinct x_3709 x_3712) (diseqTree_0 (Node_0 x_3708 x_3709 x_3710) (Node_0 x_3711 x_3712 x_3713)))))
(assert (forall ((x_3708 Tree_0) (x_3709 Int) (x_3710 Tree_0) (x_3711 Tree_0) (x_3712 Int) (x_3713 Tree_0))
...
(assert (forall ((x Int) (y Int)) (=> (> x y) (max_3 x x y))))
(assert (forall ((x Int) (y Int)) (=> (< x y) (max_3 y x y))))
(assert (forall ((x Int) (y Int)) (=> (= x y) (max_3 x x y))))

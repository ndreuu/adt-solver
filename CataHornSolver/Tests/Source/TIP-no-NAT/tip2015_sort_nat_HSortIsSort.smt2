...
(assert (forall ((x_45064 Int) (x_45065 list_169) (x_45066 Int) (x_45067 list_169))
	(=> (distinct x_45064 x_45066) (diseqlist_169 (cons_169 x_45064 x_45065) (cons_169 x_45066 x_45067)))))
(assert (forall ((x_45064 Int) (x_45065 list_169) (x_45066 Int) (x_45067 list_169))
...
(assert (forall ((x_45082 Heap_8) (x_45083 Int) (x_45084 Heap_8) (x_45085 Heap_8) (x_45086 Int) (x_45087 Heap_8))
	(=> (distinct x_45083 x_45086) (diseqHeap_8 (Node_12 x_45082 x_45083 x_45084) (Node_12 x_45085 x_45086 x_45087)))))
(assert (forall ((x_45082 Heap_8) (x_45083 Int) (x_45084 Heap_8) (x_45085 Heap_8) (x_45086 Int) (x_45087 Heap_8))
...
(assert (forall ((x Int) (y Int)) (=> (<= x y) (leq_34 true_236 x y))))
(assert (forall ((x Int) (y Int)) (=> (not (<= x y)) (leq_34 false_236 x y))))
